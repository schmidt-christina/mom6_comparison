...
for y in {1991..1997}; do
    qsub -v year=$y,expt='panan_005deg_jra55_ryf_2023_05_17',expt_name='panan_005deg_jra55_ryf',contour_depth=1500 Shelf_export_calculation.sh
   # qsub -v year=$y,expt='panan_005deg_jra55_ryf_2023_05_17',expt_name='panan_005deg_jra55_ryf',contour_depth=2500 Shelf_export_calculation.sh
done
