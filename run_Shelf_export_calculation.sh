...
for y in {1991..2009}; do
   ...
   qsub -v year=$y,expt='panant-01-zstar-ACCESSyr2',expt_name='panan_01deg_jra55_ryf',contour_depth=2000 Shelf_export_calculation.sh
   qsub -v year=$y,expt='panant-01-zstar-ACCESSyr2',expt_name='panan_01deg_jra55_ryf',contour_depth=2500 Shelf_export_calculation.sh
